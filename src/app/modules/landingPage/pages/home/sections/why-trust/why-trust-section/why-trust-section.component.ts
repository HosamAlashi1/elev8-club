  ...
  private buildStories(): TrustStory[] {
    ...
    },
    {
      ...
      bodyLines: [
        ...
        'وبنيت فريق عالمي فيه أكثر من 10,000 طالب وحققت أكثر من 10,000,000$ مبيعات في التجارة الإلكترونية خلال سنتين وتعلمت اهم مهارات البزنس بناء الأنظمة المبيعات التسويق الإدارة'
      ],
      partners: [
        {
          name: 'Danien Feier',
    ...
    },
    {
      ...
      bodyLines: [
        'وصلت للحرية المالية وحرية المكان، بس كان في شي ناقص — حرية الوقت وبعد بحث كبير قررت أبدأ التداول لأنه الشي الوحيد اللي بيجمع الثلاثة مع بعض بس لما دخلت لقيت عشوائية كبيرة — ما في نظام ما في طريق واضح هون قررت أغيّر المعادلة وبنيت الـ System اللي كنت محتاجه — خطوة بخطوة من الصفر'
      ],
    ...
    },
    {
      ...
      bodyLines: [
        `قبل عدة أشهر قدمت النسخة الأولى واللي طبقوا الخطوات قدروا يحققوا آلاف الدولارات خلال أقل من 30 يوم كررنا التجربة بالنسخة الثانية وكانت النتيجة أوضح ناس أكثر حققت نتائج حقيقية خلال أسبوع ويوم ${this.challengeDateLabel} راح أشرحلك النظام خطوة بخطوة في التحدي المباشر الجديد`
      ],
