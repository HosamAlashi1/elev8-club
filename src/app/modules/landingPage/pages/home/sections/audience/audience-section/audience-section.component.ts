...
export class AudienceSectionComponent {
  cards = [
    { icon: 'User',          title: 'العاملين من الـ5-9',         desc: 'اللي بدهم يبنوا دخل إضافي بدون ما يتركوا شغلهم الحالي' },
    ...
    { icon: 'Building2',     title: 'موظفي الشركات',              desc: 'اللي بدهم خطة خروج ذكية بدون ما يبدأوا حياتهم من الصفر' },
